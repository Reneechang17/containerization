...
/// Represents the user that should own a socket
...
public struct UnixSocketConfiguration: Sendable {
    ...
    /// The user that should own the socket. For .into direction this will
    /// be the socket in the guest. For .outOf direction this will be the 
    /// socket on the host.
